...
all_time = 0;
stop_task = False
model_directory = "/root/autodl-tmp/Tess-M-v1.0-4.0bpw-h6-exl2"
draft_directory = "/root/autodl-tmp/TinyLlama-4.0bpw"
...
def load_model():
    ...
    if not generator:
        ...
        draft_cache = ExLlamaV2Cache_8bit(draft, lazy = not draft.loaded)
        ...
        generator = ExLlamaV2StreamingGenerator(model, model_cache, tokenizer, draft, draft_cache)
        generator.warmup()
    return generator
